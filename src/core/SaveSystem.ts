import type { SaveData, SettingsData } from './Types.js';
...
export class SaveSystem {
  ...
  private migrate(input: Partial<SaveData> & { version?: number }): SaveData {
    ...
    if (version < 2 && !merged.unlockedCharacters.includes('kael-orin')) merged.unlockedCharacters.unshift('kael-orin');
    if (version < 3) {
