...
export class ProjectileSystem {
    ...
    setPlayerEmpowerment(speedMultiplier, sizeMultiplier) {
    ...
    update(dt, world) {
        ...
        this.pool.forEachActive((projectile) => {
            ...
            if (!projectile.persistent && movementDt > 0) {
                const terrainHit = world.terrain?.firstProjectileBlock(oldX, oldY, projectile.x, projectile.y, projectile.radius);
                if (terrainHit) {
