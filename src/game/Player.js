...
export class Player {
    ...
    activateBossAftermath(duration = BOSS_AFTERMATH_DURATION) {
    ...
    effectiveDamageMultiplier() {
        ...
        if (this.ultimateActive > 0)
            multiplier *= 1.1;
        if (this.bossAftermathActive())
            multiplier *= BOSS_AFTERMATH_DAMAGE_MULTIPLIER;
        return multiplier;
    }
    skillCritDamage() {
